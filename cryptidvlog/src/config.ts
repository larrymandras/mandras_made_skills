...
const EnvSchema = z.object({
  ...
  // Optional: AI vendors (required for full pipeline, not for ideation/scripting)
  OPENAI_API_KEY:              z.string().default(''),
  FAL_API_KEY:                 z.string().default(''),
  REPLICATE_API_KEY:           z.string().default(''),
  ELEVENLABS_API_KEY:          z.string().default(''),
  ELEVENLABS_YETI_VOICE_ID:    z.string().default(''),
  ELEVENLABS_BIGFOOT_VOICE_ID: z.string().default(''),
  CARTESIA_API_KEY:            z.string().default(''),
  CARTESIA_YETI_VOICE_ID:      z.string().default(''),
  CARTESIA_BIGFOOT_VOICE_ID:   z.string().default(''),

  // Optional: publishing & monitoring
  BLOTATO_API_KEY:             z.string().default(''),
